...
{
	std::vector<string> params{"-in:", "-out:" , "-log:", "-prot:"};
	std::array<string, 4> paths{ INPUT_PATH, LOG_PATH, OUTPUT_PATH, PROTOCOL_PATH };
